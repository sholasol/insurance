...
<html>
    ...
    include 'nav.php';
    $id=$_GET['id'];
    $tp=$con->query("SELECT category FROM category WHERE cat_id='$id'");
    $ro=$tp->fetch_array();
    $typ = $ro['category'];
    
    if(isset($_POST['submit'])){
        if(empty($_POST['name'])){
        $e="Please fill in the product category name!"; 
        echo  " <script>alert('$e'); window.location='Ecat.php?id=$id'</script>";
	}
        
        else{
           $nam = check_input($_POST["name"]);
           
           $pr=$con->query("UPDATE category SET category='$nam' WHERE cat_id='$id'");
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" name="name" id="exampleInputName" value="<?php echo $typ; ?>" required>
                                                                </div>
                                                                <div class="form-group col-md-12">
