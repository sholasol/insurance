...
<html>
   ...
   if(isset($_POST['submit'])){
        ...
        echo  " <script>alert('$e'); window.location='Epartner.php?id=$id'</script>";
	}
        if(empty($_POST['rc'])){
        ...
        $reg=$con->query("UPDATE users SET rc='$rc', telephone='$phone', email='$email', address='$address',  firstname='$name' WHERE user_id='$user'");
        if($reg){  
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" name="name" id="exampleInputName" value="<?php echo $ro['firstname']; ?>" required />
                                                                </div>
                                                                <div class="form-group  col-md-6">
                                                                    <label for="exampleInputName2">RC Number</label>
                                                                    <input type="text" class="form-control col-md-6" name="rc" id="rc" value="<?php echo $ro['rc']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputName">Phone</label>
                                                                    <input type="text" class="form-control" name="phone" id="phone" value="<?php echo $ro['telephone']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputEmail">Email address</label>
                                                                    <input type="email" class="form-control" name="email" id="email" value="<?php echo $ro['email']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputEmail">Office address</label>
                                                                    <input type="text" class="form-control" name="address" id="address" value="<?php echo $ro['address']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-12">
