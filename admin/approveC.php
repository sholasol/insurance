                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group  col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control col-md-6" name="exampleInputName2" id="exampleInputName2"  >
                                                                </div>
                                                                <div class="form-group  col-md-6">
                                                                ...
                                                                <div class="form-group  col-md-6">
                                                                    ...
                                                                    <input type="number" class="form-control col-md-6" name="exampleInputName2" id="exampleInputName2"  >
                                                                </div>
