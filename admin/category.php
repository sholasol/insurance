...
<html>
    ...
    if(isset($_POST['submit'])){
        if(empty($_POST['name'])){
        $e="Please fill in the category name!"; 
        echo  " <script>alert('$e'); window.location='category.php'</script>";
	}
           ...
           $chk=$con->query("SELECT count(cat_id) AS count FROM category WHERE category='$nam' AND insurance_id='$inss'");
           $rr=$chk->fetch_array();
           $num=$rr['count'];
           ...
           if($num > 0){
               ...
               $pr=$con->query("INSERT INTO category SET category='$nam', insurance_id='$inss', created_by='$userid', created=now()");
               
               
           if($pr){
               $e="Operation successful."; 
                echo  " <script>alert('$e'); window.location='cats.php'</script>";
           }else{
            $e="Processing error."; 
            echo  " <script>alert('$e'); window.location='category.php'</script>";
            }
                                ...
                                <div class="panel-body">
                                    <div id="rootwizard">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab1" data-toggle="tab"><i class="fa fa-bars m-r-xs"></i>Product Category</a></li>
                                        </ul>
