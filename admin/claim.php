                                ...
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php
                                            $cus=$con->query("SELECT * FROM users, claims WHERE users.user_id = claims.user_id AND claims.insurance_id='$i_id'");
                                            $counter =0;
                                                ...
                                                <td>
                                                    <div class="input-group-btn pull-left">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                           <?php 
                                                           echo" <li><a href='claim_process.php?id=$id' title='Process Claim' ><i class='fa fa-briefcase'></i>Process Claim </a></li>"; 
                                                           echo" <li><a href='#?id=$id'  ><i class='fa fa-comment'></i>Comment </a></li>";
                                                           echo" <li><a href='#?id=$id' title='Authorize Payment of this Claim' ><i class='fa fa-dollar'></i>Authorize Payment</a></li>";
                                                           ?>
                                                        </ul>
                                                    </div>
                                                </td>
