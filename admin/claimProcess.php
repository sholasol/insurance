                                ...
                                <div class="panel-body">
                                    <div id="rootwizard">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab1" data-toggle="tab"><i class="fa fa-briefcase m-r-xs"></i>Policy Number</a></li>
                                        </ul>
                                                            ...
                                                            <div class="row">
                                                                <div class="inline">
                                                                 <div class=" form-group">
                                                                    <label>
                                                                        <input type="radio" name="policy" value="policyno"> Policy Number
                                                                    </label>
                                                                     <label>
                                                                        <input type="radio" name="policy" value="phoneno"> Phone Number
                                                                    </label>
                                                                </div>
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputName">Policy Number</label>
                                                                    <input type="text" class="form-control" name="policy Number" id="exampleInputName" placeholder="Enter your policy number">
                                                                </div>
                                                                <div class="form-group col-md-12">
