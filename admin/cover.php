...
if(isset($_POST['submit'])){
        ...
        echo  " <script>alert('$e'); window.location='cover.php&id=$id'</script>";
	}
           ...
           foreach ($_POST['cover'] as $cover => $value){
               $cov= $_POST['cover'][$cover];
               $amt=$_POST['amount'][$cover];
               //$amount= $_POST['amount'][$cover];
               
               $pr=$con->query("INSERT INTO cover SET plan_id='$planid', product_id='$prod', cover='$cov', amount='$amt', created=now()");
           }
           
           if($pr){
               $e="Plan cover has been successfully created."; 
                echo  " <script>alert('$e'); window.location='managecover.php?id=$planid&prod=$prod'</script>";
           }else{
            $e="Processing error."; 
            echo  " <script>alert('$e'); window.location='cover.php?id=$id'</script>";
            }
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <div class="row">
                                                                <div class="wrapper">
                                                                    ...
                                                                    <div class="form-group  col-md-6">
                                                                        <label for="exampleInputName2">Cover Amount</label>
                                                                        <input type="number" class="form-control" name="amount[]" id="exampleInputName" placeholder="Cover Amount" required>
                                                                    </div>
                                                                </div>
                                                            </div>    
                                                            <div class="row">
                ...
                var y =max_fields + 1;
                    ...
                    if(x < max_fields){ 
                        ...
                        $(wrapper).append('<div><br>\n\
                            <div class="col-md-6"><label for="exampleInputName2">New Cover</label> <input type="text" class="form-control" name="cover[]" placeholder="Cover" /> </div>     \n\
                            <div class="col-md-6">  <label for="exampleInputName2">Cover Amount</label> <input type="text" class="form-control" name="amount[]" placeholder="Cover Amount" /> </div>\n\
                            <a href="javascript:void(0);" class="remove_field pull-right" style="color: red;"><i class="fa fa-trash"> Remove</i></a> \n\
                        </div>');
                    }
