...
if(isset($_POST['submit'])){
        ...
        echo  " <script>alert('$e'); window.location='editP.php'</script>";
	}
           ...
           $pr=$con->query("UPDATE product_setup SET product_name='$nam', insurance_id='$inss', status='Active', category='$cat', type='$type' WHERE product_id='$id'");
           
           if($pr){
               $e="The product has been successfully updated."; 
                                                                ...
                                                                <div class="form-group  col-md-6">
                                                                 ...
                                                                 <div class="form-group col-md-6">
                                                                    ...
                                                                    <select name="cat" class="form-control" required>
                                                                        ...
                                                                        <option value="Livestock">Trading</option>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group col-md-12">
