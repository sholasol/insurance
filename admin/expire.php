                                   ...
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                            //Policy Details
                                            $cus=$con->query("SELECT * FROM transaction WHERE insurance_id='$i_id' AND status ='Terminated'");
                                            $counter =0;
                                            while($row=$cus->fetch_array()){
                                                ...
                                                $cst=$con->query("SELECT * FROM users WHERE user_id='$usr'");
                                                $r=$cst->fetch_array();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="renew.php?ren=<?php echo $pol ?>" class="label label-primary">Renew Policy</a>
                                                </td>
