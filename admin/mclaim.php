    ...
    if(isset($_POST['submit'])){
        ...
        echo  " <script>alert('$e'); window.location='mclaim.php?policy=$pol'</script>";
           ...
           $date = check_input($_POST["date"]);
            ...
            $clm=$con->query("INSERT INTO claims SET insurance_id='$insurance', user_id='$usr', policy='$poly',product='$prd', plan='$plan', premium='$prm', sum_assured='$sum', notif_date=now(), incident_date ='$dat', claim_amount ='$claim', nature_of_loss='$nature', narration='$naration' ");
            if($clm){
...
<!--                                                                <div class="form-group col-md-6">
                                                                 ...
                                                                 <div class="form-group  col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control col-md-6" name="product" id="exampleInputName2" value="<?php echo $rw['product_name']?>"  required />
                                                                </div>
                                                                ...
                                                                <div class="form-group  col-md-6">
                                                                    ...
                                                                    <input type="number" class="form-control col-md-6" name="claim" id="exampleInputName2"  required/>
                                                                </div>
<!--                                                                <div class="form-group  col-md-6">
