...
<div class="page-inner">
    <div class="page-title">
        ...
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li><a href="manageP.php">Manage Partners</a></li>
                <li><a href="#">Create Commission</a></li>
            </ol>
        </div>
    </div>
     <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Create Commission for Each Plan</h4>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php
                                            $pr=$con->query("SELECT plan_setup.plan_id, plan_setup.name, plan_setup.premium, plan_setup.sum_assured, plan_setup.commission,product_setup.product_id, product_setup.product_name  FROM plan_setup, product_setup WHERE plan_setup.product_id=product_setup.product_id AND product_setup.insurance_id='$i_id'");
                                            $counter=0;
                                                ...
                                                <td>
                                                    <div class="input-group-btn">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                           <?php echo"
                                                                 <li><a href='commission.php?id=$id&prod=$pid' title='Assign Commission' ><i class='fa fa-dollar'></i>Create Commission</a></li>
                                                                 <li><a href='vplan.php?id=$id&prod=$pid' title='View Commission' ><i class='fa fa-credit-card'></i>View Commission</a></li>
                                                               ";?> 
                                                        </ul>
                                                    </div>
                                                </td>
 ...
 if(isset($_GET['id'])){
    ...
    $del=$con->query("DELETE FROM plan_setup WHERE plan_id='$pl'");
    
    if($del){
        
        $del_cov=$con->query("DELETE FROM cover WHERE plan_id='$pl'");
        
        if($del_cov){
            $e="The Plan has been successfully deleted."; 
            echo  " <script>alert('$e'); window.location='plans.php'</script>";
        }
        }
    }
 ?>