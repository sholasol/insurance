    ...
    <div class="page-title">
        ...
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li><a href="custPol.php?id=<?php echo $id; ?>&pol=<?php echo $pol;?>">Customer</a></li>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <address>
                                                <i class="fa fa-envelope"></i>: <?php echo $ru['email'] ?><br>
                                        ...
                                        <div class="col-md-8 text-right">
                                            <h1> Schedule</h1>
                                            <a href="ren.php?pol=<?php echo $pol;?>" class="btn btn-default btn-primary"><i class="fa fa-refresh"></i> Renew</a>
                                        </div>
                                        <div class="col-md-12">
                                            <hr>
                                            <p>
                                        ...
                                        <div class="col-md-4">
                                            <label class="label label-primary pull-left">Policy Beneficiaries</label>
                                            <table class="table table-striped">
                                                    <?php
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><span class="pull-left"><?php echo $br['firstname']." ".$br['lastname']; ?></span></td>
                                                        <td></td>
                                                    </tr>
                                                    <?php } ?>
                                                </table>
                                        ...
                                        <div class="col-md-4">
                                            <div class="text-right">
                                                <label class="label label-primary">Policy Cover</label>
                                                <table class="table table-striped">
                                                    <?php 
