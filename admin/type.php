...
<html>
    ...
    if(isset($_POST['submit'])){
        if(empty($_POST['name'])){
        $e="Please fill in the product type name!"; 
        echo  " <script>alert('$e'); window.location='type.php'</script>";
	}
           ...
           $chk=$con->query("SELECT count(type_id) AS count FROM product_type WHERE type='$nam' AND insurance_id='$inss'");
           $rr=$chk->fetch_array();
           $num=$rr['count'];
            
           if($num > 0){
               $e="This $nam Already exists."; 
                echo  " <script>alert('$e'); window.location='type.php'</script>";
           }else{
               $pr=$con->query("INSERT INTO product_type SET type='$nam', insurance_id='$inss', created_by='$userid', created=now()");
               
               
           if($pr){
               $e="Operation successful."; 
                echo  " <script>alert('$e'); window.location='types.php'</script>";
           }else{
            $e="Processing error."; 
            echo  " <script>alert('$e'); window.location='type.php'</script>";
            }
                                ...
                                <div class="panel-body">
                                    <div id="rootwizard">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab1" data-toggle="tab"><i class="fa fa-bars m-r-xs"></i>Product Type</a></li>
                                        </ul>
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputName">Product Type</label>
