                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <a href="type.php" class="panel-title pull-right"><i class="fa fa-plus-circle"></i> Create New</a>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        $pr=$con->query("SELECT * FROM product_type WHERE insurance_id='$i_id'     " );
                                        $counter=0;
                                            ...
                                            <td>
                                                <div class="input-group-btn pull-left">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                       <?php  
                                                       echo" <li><a href='Etype.php?id=$id' title='Edit Type' ><i class='fa fa-edit'></i>Edit Type </a></li> ";  
                                                       ?>
                                                    </ul>
                                                </div>
                                            </td>
