                                ...
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php
                                            $pr=$con->query("SELECT  plan_setup.name, product_setup.product_name,  rate.commission  FROM plan_setup, product_setup, rate WHERE product_setup.product_id = plan_setup.product_id AND product_setup.product_id = rate.product_id AND product_setup.product_id='$prd'");
                                            $counter=0;
                                                ...
                                                <td>
                                                    <div class="input-group-btn">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu"> 
                                                            ...
                                                            <li><a href="manageProd.php?id=<?php // echo $id;?>" title="Delete Plan" onclick="return confirm('Delete this Plan ?')"><i class="fa fa-trash"></i>Delete Plan</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                                <td>
