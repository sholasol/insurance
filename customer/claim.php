                                ...
                                <div class="panel-body">
                                    <div id="rootwizard">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab1" data-toggle="tab"><i class="fa fa-dollar m-r-xs"></i>Claims</a></li>
                                        </ul>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active fade in" id="tab1">
                                                    <div class="row m-b-lg">
                                                        <div class="col-md-10">
                                                            <span class="col-md-10 text-center text-primary"><h4>Enter your policy or Phone number</h4></span><hr/>
                                                            <div class="row">
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputName">Policy No.</label>
                                                                    <input type="text" class="form-control" name="policy" id="policy" placeholder="Policy Number">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputName">Phone</label>
                                                                    <input type="text" class="form-control" name="phone" id="exampleInputName" placeholder="Phone Number">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                 <button type="submit" name="submit" class="btn btn-success pull-right">Fetch</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="input-group-btn">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                           ...
                                                           echo "<li><a href='mclaim.php?policy= $pol' title='Make claim request' onclick='return confirm('Make claim request?')'><i class='fa fa-briefcase'></i>Make Claim</a></li>";
                                                           echo "<li><a href='eclaim.php?policy= $pol' title='Edit Claim' onclick='return confirm('Edit Claim?')'><i class='fa fa-pencil'></i>Edit Claim</a></li>";
                                                           //if($cnt > 0){}
                                                ...
                                                <td><?php  echo "=N= ".number_format($rw['claim_amount']) ;?></td>
