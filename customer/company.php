...
<html>
    <head>
        ...
        <link href="../res/plugins/pricing-tables/css/style.css" rel="stylesheet" type="text/css">
                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="#">Select a Company</a></li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                                ...
                                <div class="panel-body">
                                    <div class="cd-pricing-container">
                                        <div class="cd-pricing-switcher">
                                            <p class="fieldset">
                                                <span class="no-uniform btn btn-rounded btn-info">Select an Insurance Company</span>
                                            </p>
                                        </div>
                                        <ul class="cd-pricing-list cd-bounce-invert">
                                            <?php 
                                            $cop=$con->query("SELECT * FROM insurance_company");
                                            while($r=$cop->fetch_array()){
                                                $id= $r['company_id'];
                                                
                                                $cn=$con->query("SELECT count(product_id) AS count FROM product_setup WHERE insurance_id='$id'");
                                                $ro=$cn->fetch_array();
                                                $cnt=$ro['count'];
                                                ...
                                                <ul class="cd-pricing-wrapper">
                                                    <li data-type="monthly" class="is-visible">
                                                        <header class="cd-pricing-header">
                                                            <h2><i class="fa fa-bank"></i> <?php echo $r['company_name']; ?></h2>
                                                            <div class="cd-price">
                                                                <span class="cd-value"><?php echo $cnt; ?></span>
                                                                <span class="cd-duration">Products</span>
                                                            </div>
                                                            <span><i class="fa fa-phone bx"></i>: <?php echo $r['phone_no']; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <span><i class="fa fa-envelope"></i>: <?php echo $r['email']; ?></span>
                                                        </header>
                                                        <footer class="cd-pricing-footer">
                                                            <a class="cd-select" href="product.php?id=<?php echo $id; ?>">Select</a>
                                                        </footer>
                                                    </li>
                                                </ul>
                                            </li>
