...
<html>
    ...
    <?php 
    include 'nav.php';
    $pol= check_input($_GET['pol']);
    $ins= $con->query("SELECT insurance_id FROM transaction WHERE policy='$pol'");
    $r=$ins->fetch_array();
    ...
    if(isset($_POST['submit'])){
        ...
        echo  " <script>alert('$e'); window.location='complains.php'</script>";
	}
        ...
        echo  " <script>alert('$e'); window.location='complains.php'</script>";
           ...
           $policy = check_input($_POST["policy"]);
            ...
            $clm=$con->query("INSERT INTO complain SET userID='$uid',complain ='$comp', policy='$pol', insurance='$ins_id', created=now() ");
            if($clm){
