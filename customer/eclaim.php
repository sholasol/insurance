...
<html>
    ...
    $chk =$con->query("SELECT * FROM claims WHERE policy='$pol' AND status='Pending'");
    $rv=$chk->fetch_array();
    $claim=$rv['claim_amount'];
    $incident= $rv['incident_date'];
    $natur= $rv['nature_of_loss'];
    $narat= $rv['narration'];
    ...
    if(isset($_POST['submit'])){
        ...
        echo  " <script>alert('$e'); window.location='eclaim.php?policy=$pol'</script>";
           ...
           $naration = check_input($_POST["naration"]);
            ...
            $clm=$con->query("UPDATE claims SET  claim_amount ='$claim', nature_of_loss='$nature', narration='$naration' WHERE policy='$pol' AND status='Pending' ");
            if($clm){
                $act=$con->query("INSERT INTO activities SET userID='$uid', activity='Updated Claim Process', query='Edit', role='4', created=now() ");
                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="#">Claim Process <?php echo $narat;?></a></li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                                ...
                                <div class="panel-body">
                                    <div id="rootwizard">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab1" data-toggle="tab"><i class="fa fa-briefcase m-r-xs"></i>Edit Claim </a></li>
                                        </ul>
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" name="name" id="exampleInputName" value="<?php echo $name; ?>" disabled>
                                                                </div>
                                                                 <div class="form-group  col-md-6">
                                                                    <label for="exampleInputName2">Product Name</label>
                                                                    <input type="text" class="form-control col-md-6" name="product" id="exampleInputName2" value="<?php echo $prdName; ?>" disabled required />
                                                                </div>
                                                                ...
                                                                <div class="form-group  col-md-6">
                                                                    ...
                                                                    <input type="number" class="form-control col-md-6" name="claim" id="exampleInputName2" value="<?php echo $claim;?>"  required/>
                                                                </div>
                                                                <div class="form-group  col-md-6">
                                                                    <label for="exampleInputName2">Incident Date</label>
                                                                    <input type="text" class="form-control col-md-6" name="date" id="exampleInputName2" value="<?php echo $incident;?>" disabled required />
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputEmail">Nature of Loss</label>
                                                                    <textarea class="form-control" name="nature" id="exampleInputEmail" rows="4"  required><?php echo $natur;?></textarea>
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputEmail">Narration of Loss</label>
                                                                    <textarea class="form-control" name="naration" id="exampleInputEmail" rows="4"  required><?php echo $narat;?></textarea>
                                                                </div>
                                                                <div class="form-group col-md-12">
