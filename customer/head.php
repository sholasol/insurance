                            ...
                            <ul class="nav navbar-nav navbar-left">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        <span class="user-name"><i class="fa fa-book"></i> Policy<i class="fa fa-angle-down"></i></span>
                                    </a>
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        <li role="presentation"><a href="company.php"><i class="fa fa-briefcase"></i>New Policy</a></li>
                                        <li role="presentation"><a href="mpolicy.php"><i class="fa fa-list-alt"></i>Manage Policy</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        <li role="presentation"><a href="claim.php"><i class="fa fa-credit-card "></i>New Claims</a></li>
                                        <!--<li role="presentation"><a href="pclaim.php"><i class="fa fa-credit-card"></i>Pending Claim</a></li>-->
                                    </ul>
                                </li>
                                <li>	
