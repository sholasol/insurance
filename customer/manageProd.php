...
<html>
    ...
    $prd=$_GET['prod'];
    $pp= $con->query("SELECT insurance_id FROM product_setup WHERE product_id='$prd'  ");
    $rr=$pp->fetch_array();
    $ins=$rr['insurance_id'];
    ?>
    ...
    <div class="page-title">
        ...
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li><a href="product.php?id=<?php echo $ins; ?>">Product</a></li>
        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                <div class="panel-heading clearfix">
                    <?php
                    $insu=$con->query("SELECT * FROM product_setup WHERE product_id='$prd'  ");
                    $row=$insu->fetch_array();
                    ?>
                    <h2 class="panel-title center"> <?php echo $row['product_name']; ?></h2>
                </div>
                <div class="panel-body">
                   <div class="table-responsive"> 
                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                        ...
                        <tbody>
                            <?php
                                $co=$con->query("SELECT * FROM plan_setup WHERE product_id='$prd'");
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                    $cv=$con->query("SELECT * FROM cover WHERE plan_id='$plan'");
                                    while($rx=$cv->fetch_array()){
                                        $cov=$rx['cover'];
                                        $amt= number_format($rx['amount']);
                                        echo"<span class='pull-left'>$cov</span><span class='pull-right label label-info'>$amt</span><br>";
                                    }
                                    ?>
                                        
                                </td>
                                <td>
                                    <a class="btn btn-info btn-rounded" href="policy2.php?id=<?php echo $ins; ?>&prd=<?php echo $prd; ?>&pln=<?php echo $plan; ?>">Buy Plan</a>
                                </td>
                            </tr>
                            <?php } ?>
