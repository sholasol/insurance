            ...
            <div class="horizontal-bar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon fa fa-book"></span><p>Policy</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li role="presentation"><a href="company.php">New Policy</a></li>
                                <li role="presentation"><a href="mpolicy.php">Manage Policy</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon fa fa-exclamation-circle"></span><p>Complain</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li role="presentation"><a href="complaints.php">View Complain</a></li>
                                <li role="presentation"><a href="complain.php">Make Complain</a></li>
                            </ul>
                        </li>
                    </ul>
