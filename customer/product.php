                                ...
                                <div class="panel-body">
                                    <div class="cd-pricing-container">
                                        <div class="cd-pricing-switcher">
                                            <p class="fieldset">
                                                <span class="no-uniform btn btn-rounded btn-info">Products</span>
                                            </p>
                                        </div>
                                        <ul class="cd-pricing-list cd-bounce-invert">
                                            <?php 
                                            $cop=$con->query("SELECT * FROM product_setup WHERE insurance_id='$id'");
                                                ...
                                                <ul class="cd-pricing-wrapper">
                                                    <li data-type="monthly" class="is-visible">
                                                        <header class="cd-pricing-header">
                                                            <h2><i class="fa fa-briefcase"></i> <?php echo $r['product_name']; ?></h2>
                                                            <div class="cd-price">
                                                                <span class="cd-duration"><a href="manageProd.php?id=<?php echo $id; ?>&prod=<?php echo $prd; ?>">View More</a></span>
                                                            </div>
                                                        </header>
                                                        <footer class="cd-pricing-footer">
                                                            <a class="cd-select" href="policy.php?id=<?php echo $id; ?>&prd=<?php echo $prd; ?>">Buy</a>
                                                        </footer>
                                                    </li>
                                                </ul>
                                            </li>
