                                ...
                                <div class="panel-body">
                                    <div id="rootwizard">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab1" data-toggle="tab"><i class="fa fa-bars m-r-xs"></i>Customer Details</a></li>
                                        </ul>
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="exampleInputName" id="exampleInputName" placeholder="Telephone Number">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                ...
                                                                <span class="col-md-12 btn">Beneficiary Information</span>
                                                                <div class="form-group col-md-6">
