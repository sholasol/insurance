...
<html>
    ...
    if(isset($_POST['submit'])){
        ...
        $ir=$inD->fetch_array();
        $insurance =$ir['insurance_id'];
        
        $ra=$con->query("SELECT commission FROM rate WHERE partner_id ='$ptn' AND product_id='$prod' AND plan='$plan' AND insurance_id='$insurance'");
        $p=$ra->fetch_array();
        $comm = $p['commission'];
        $c_rate = $comm/100;
        $c_amt = $prm * $c_rate;
        ...
        //Market commission is 50% of the partner's commission
        $mkt_com= $c_amt * 0.5;
       ...
       //Calculating End date from start date
        ...
        if($count < 1){
            ...
            if($reg){
                ...
                $tr=$con->query("INSERT INTO transaction SET user_id='$idd',insurance_id='$insurance', partner_id ='$ptn', marketer_id='$uid',  product='$prod', plan='$plan',  policy='$pol_no', start_date='$start', end_date='$end', premium ='$prm', sum_assured='$sma',  
                ...
                //Customer had not been profiled by the same partner before
                    $innx=$con->query("INSERT INTO  icustomer SET insurance_id ='$insurance', partner_id ='$ptn', customer_id= '$idd'");
                    //Pair customer with partner that created the marketer
                    $inPx=$con->query("INSERT INTO  pcustomer SET partner_id ='$ptn', user_id= '$idd'");
                    
                    //Pair the customer with the marketer
                    $inPy=$con->query("INSERT INTO  mcustomer SET partner_id ='$ptn', marketer_id='$uid', user_id= '$idd'");
                
                 //Partner's commission
                $comm2=$con->query("INSERT INTO commission SET insurance_id='$insurance', plan_id ='$plan', partner_id = '$ptn', marketer_id ='$uid',  product_id ='$prod',  policy ='$pol_no',premium='$prm', commission_rate='$comm', commission_percentage='$c_rate', marketer_com='$mkt_com', commission_value ='$c_amt', created =now() ");
            ...
            $tr2=$con->query("INSERT INTO transaction SET user_id='$usr',insurance_id='$insurance', partner_id ='$ptn', marketer_id='$uid',  product='$prod', plan='$plan',  policy='$pol_no', start_date='$start', end_date='$end', premium ='$prm', sum_assured='$sma',  
               payment_freq='$freq',  underwriting_year='$year', transaction_date='$start', captured_by='$user_id', duration='$term', chasis_no='$chasis',     
                car_make='$make', car_model='$model', reg_no_car='$regno', status='Active',  is_renewal='No'  
                ");
            
            //Partner's and marketer commission
                $comm3=$con->query("INSERT INTO commission SET insurance_id='$insurance', plan_id ='$plan', partner_id = '$ptn', marketer_id ='$uid',  product_id ='$prod',  policy ='$pol_no',premium='$prm', commission_rate='$comm', commission_percentage='$c_rate', marketer_com='$mkt_com', commission_value ='$c_amt', created =now() ");
            ...
            if($check < 1){
                ...
                $ch_pcustomer=$con->query("SELECT count(user_id) AS counts FROM pcustomer WHERE partner_id ='$ptn' AND user_id= '$usr' ");  
                $rp=$ch_pcustomer->fetch_array();
                $checkP=$rp['counts'];
                if($checkP > 0){
                    
                    //Ckecking if the customer had been profiled for the same marketer
                    $ch_mcust=$con->query("SELECT count(user_id) AS counts FROM mcustomer WHERE marketer_id ='$uid' AND user_id= '$usr' ");  
                    $to=$ch_mcust->fetch_array();
                    $checkM=$to['counts'];
                    
                    if($checkM > 0){
                        
                        //User had already been profiled by the same marketer in the past
                        $in_ins1=$con->query("INSERT INTO  icustomer SET insurance_id ='$insurance', customer_id= '$idd'");
                        
                        $in_bef1=$con->query("INSERT INTO beneficiary SET policy='$pol_no', firstname='$bfname', lastname='$blname', email='$bemail', phone_no='$bphone', address='$baddress'");
                    ...
                    if($checkM < 1){
                        //User has not been  profiled by the same marketer in the past
                        $in_ins2=$con->query("INSERT INTO  icustomer SET insurance_id ='$insurance', customer_id= '$idd'");
                        //Pair the customer with the marketer
                        $inPx2=$con->query("INSERT INTO  mcustomer SET partner_id ='$ptn', marketer_id='$uid', user_id= '$usr'");
                        
                        $in_bef2=$con->query("INSERT INTO beneficiary SET policy='$pol_no', firstname='$bfname', lastname='$blname', email='$bemail', phone_no='$bphone', address='$baddress'");
                ...
                elseif($checkP < 1){
                    ...
                    //Ckecking if the customer had been profiled for the same marketr
                    $ch_mcust2=$con->query("SELECT count(user_id) AS counts FROM mcustomer WHERE marketer_id ='$uid' AND user_id= '$usr' ");  
                    $ta=$ch_mcust2->fetch_array();
                    $checkM2=$ta['counts'];
                    
                    if($checkM2 > 0){
                        
                        //Customer had not been profiled by the same partner before
                        $innx=$con->query("INSERT INTO  icustomer SET insurance_id ='$insurance', customer_id= '$usr'");
                        //Pair customer with partner
                        $inPx3=$con->query("INSERT INTO  pcustomer SET partner_id ='$ptn', customer_id= '$usr'");

                        $benfx=$con->query("INSERT INTO beneficiary SET policy='$pol_no', firstname='$bfname', lastname='$blname', email='$bemail', phone_no='$bphone', address='$baddress'");
                    ...
                    if($checkM2 < 1){
                        ...
                        $inPx3=$con->query("INSERT INTO  pcustomer SET partner_id ='$ptn', customer_id= '$usr'");
                        //Pair the customer with the marketer
                        $inPx4=$con->query("INSERT INTO  mcustomer SET partner_id ='$ptn', marketer_id='$uid', user_id= '$usr'");
