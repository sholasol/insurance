       ...
       //Calculating End date from start date
        ...
        if($count < 1){
            ...
            if($reg){
                ...
                $tr=$con->query("INSERT INTO transaction SET user_id='$idd',insurance_id='$insurance', partner_id ='$patID', marketer_id ='$uid', product='$prod', plan='$plan',  policy='$pol_no', start_date='$start', end_date='$end', premium ='$prm', sum_assured='$sma',  
               payment_freq='$freq',  underwriting_year='$year', transaction_date='$start', captured_by='$user_id', duration='$term', chasis_no='$chasis',     
                ...
                //mapping customer to partner
                $inn2=$con->query("INSERT INTO  pcustomer SET partner_id ='$patID', user_id= '$idd'");
                ...
                $comm2=$con->query("INSERT INTO commission SET insurance_id='$insurance', plan_id ='$plan', partner_id = '$patID', product_id ='$prod',  policy ='$pol_no',premium='$prm', commission_rate='$comm', commission_percentage='$c_rate', commission_value ='$c_amt', created =now() ");
                
                
                $inn=$con->query("INSERT INTO  mcustomer SET partner_id ='$patID', marketer_id ='$uid', user_id= '$idd'");
                if($inn){
                                        ...
                                        <form id="wizardForm" method="post" action="">
                                            <div class="tab-content">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="number" class="form-control" name="phone" id="exampleInputName" placeholder="Telephone Number" required>
                                                                </div>
                                                                <div class="form-group  col-md-6">
                                                                    <label for="exampleInputName2">Date of Birth</label>
                                                                    <input type="text" class="form-control col-md-6 date-picker" name="dob" id="exampleInputName2" placeholder="Date of Birth" required>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="password" class="form-control" name="password" id="exampleInputEmail" placeholder="Create a password" >
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputEmail">Home address</label>
                                                                    <input type="text" class="form-control" name="address" id="exampleInputEmail" placeholder="Residential Address" >
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="form-group col-md-6">
                                                                    ...
                                                                    <select class="form-control"  name="product" id="product" required>
                                                                        ...
                                                                        <?php 
                                                                        $pro= $con->query("SELECT * FROM product_setup");
                                                ...
                                                <div class="tab-pane fade" id="tab3">
                                                    ...
                                                    <div class="row">
                                                        <label class="col-md-12 btn btn-primary">Next of Kin Information</label>
                                                        <div class="col-md-12">
                                                            <div class="form-group col-md-6">
                                                                <label for="exampleInputName">First Name</label>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label for="exampleInputName">Phone</label>
                                                                <input type="text" class="form-control" name="nphone" id="exampleInputName" placeholder="Telephone Number" required>
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                <label for="exampleInputHolder">Address</label>
