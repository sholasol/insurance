...
<div class="page-inner">
                    ...
                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                        ...
                        <tbody>
                            ...
                            while($row=$cus->fetch_array()){
                                ...
                                $cnt=$con->query("SELECT  policy, count(transaction_id) AS transaction, count(policy) AS count, sum(premium) AS premium FROM transaction WHERE user_id='$id'");
                                $ro=$cnt->fetch_array();
                                $pol=$ro['policy'];
                            ?>
                            <tr>
                                    ...
                                    <div class="input-group-btn">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                           <?php echo" <li><a href='viewC.php?id=$id' title='Edit Cover' ><i class='fa fa-user'></i>View Detail</a></li>";?>
                                            <li><a href="manageC.php?pol=<?php echo $pol;?>" title="Terminate Policy" onclick="return confirm('Terminate this Policy ?')"><i class="fa fa-trash"></i>Termination Request</a></li>
                                        </ul>
                                    </div>
                                </td>
 ...
 if(isset($_GET['pol'])){
    ...
    $del=$con->query("UPDATE transaction SET status='Terminated' WHERE policy='$pol'");
