                                   ...
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            $pr=$con->query("SELECT users.firstname, users.lastname, users.telephone, users.email, users.created, users.address, pmarketer.partner_id FROM
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" title="Edit Marketer"><i class="fa fa-edit"></i></a>
                                                    <a class="btn btn-danger" title="Terminate Marketer"><i class="fa fa-close"></i></a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
