                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    ...
                                    <h4 class="panel-title pull-right"><a href="Phistory.php"><i class="fa fa-archive"></i> History</a></h4>
                                </div>
                                   ...
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                            $p=0;
                                            $cus=$con->query("SELECT * FROM users, transaction WHERE users.user_id = transaction.user_id AND transaction.partner_id='$uid' AND transaction.status !='Terminated' GROUP BY users.user_id");
                                            $counter =0;
                                            while($row=$cus->fetch_array()){
                                                ...
                                                $cnt2=$con->query("SELECT commission_value FROM commission WHERE partner_id='$uid' AND status='Pending' ");
                                                $rw=$cnt2->fetch_array();
