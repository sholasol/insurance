...
<html>
    ...
    if(isset($_POST['submit'])){
        ...
        $ra=$con->query("SELECT commission FROM rate WHERE partner_id ='$uid' AND product_id='$prod' AND plan='$plan' AND insurance_id='$insurance'");
        $p=$ra->fetch_array();
        $comm = $p['commission'];
        $c_rate = $comm/100;
        $c_amt = $prm * $c_rate;
       ...
       //Calculating End date from start date
        ...
        if($count < 1){
            ...
            if($reg){
                ...
                $tr=$con->query("INSERT INTO transaction SET user_id='$idd',insurance_id='$insurance', partner_id ='$user_id',  product='$prod', plan='$plan',  policy='$pol_no', start_date='$start', end_date='$end', premium ='$prm', sum_assured='$sma',  
                ...
                //assigning the customer to partner
                $inn2=$con->query("INSERT INTO  pcustomer SET partner_id ='$uid', user_id= '$idd'");
                
                 //Partner's commission
                $comm2=$con->query("INSERT INTO commission SET insurance_id='$insurance', plan_id ='$plan', partner_id = '$uid', product_id ='$prod',  policy ='$pol_no',premium='$prm', commission_rate='$comm', commission_percentage='$c_rate', commission_value ='$c_amt', created =now() ");
            ...
            $tr2=$con->query("INSERT INTO transaction SET user_id='$usr',insurance_id='$insurance', partner_id ='$user_id',  product='$prod', plan='$plan',  policy='$pol_no', start_date='$start', end_date='$end', premium ='$prm', sum_assured='$sma',  
               payment_freq='$freq',  underwriting_year='$year', transaction_date='$start', captured_by='$user_id', duration='$term', chasis_no='$chasis',     
                car_make='$make', car_model='$model', reg_no_car='$regno', status='Active',  is_renewal='No'  
                ");
            ...
            //Partner's commission
                $comm3=$con->query("INSERT INTO commission SET insurance_id='$insurance', plan_id ='$plan', partner_id = '$uid', product_id ='$prod',  policy ='$pol_no',premium='$prm', commission_rate='$comm', commission_percentage='$c_rate', commission_value ='$c_amt', created =now() ");
            ...
            if($check < 1){
                ...
                $checkP=$rp['counts'];
                if($checkP > 0){
                    //User had already been profiled by the same partner in the past
                    $in_ins=$con->query("INSERT INTO  icustomer SET insurance_id ='$insurance', customer_id= '$idd'");
                    $in_bef=$con->query("INSERT INTO beneficiary SET policy='$pol_no', firstname='$bfname', lastname='$blname', email='$bemail', phone_no='$bphone', address='$baddress'");
                ...
                elseif($checkP < 1){
                    ...
                    $inPx=$con->query("INSERT INTO  pcustomer SET partner_id ='$uid', customer_id= '$usr'");
            ...
            elseif($check > 0){
                ...
                //Ckecking if the customer had been profiled for the same partner
                $ch_pcustomerx=$con->query("SELECT count(user_id) AS counts FROM pcustomer WHERE partner_id ='$uid' AND user_id= '$usr' ");  
                $rpx=$ch_pcustomerx->fetch_array();
                $checkPx=$rpx['counts'];
                if($checkPx > 0){
                    
                    //Customer had alreday been profiled
                    
                    $benfy=$con->query("INSERT INTO beneficiary SET policy='$pol_no', firstname='$bfname', lastname='$blname', email='$bemail', phone_no='$bphone', address='$baddress'");
                ...
                elseif($checkPx < 1){
                    //Customer had not been profiled by the same partner
                    $inP=$con->query("INSERT INTO  pcustomer SET partner_id ='$uid', customer_id= '$usr'");
                    $benf5=$con->query("INSERT INTO beneficiary SET policy='$pol_no', firstname='$bfname', lastname='$blname', email='$bemail', phone_no='$bphone', address='$baddress'");
