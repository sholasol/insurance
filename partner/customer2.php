...
<html>
    ...
    if(isset($_POST['submit'])){
        ...
        $ra=$con->query("SELECT commission FROM rate WHERE partner_id='$uid' AND plan_id='$plan'");
        $p=$ra->fetch_array();
        $comm = ['commission'];
        $com_amt= $prm * ($comm/100);
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="form-group col-md-6">
                                                                    ...
                                                                    <select class="form-control"  name="product" id="product" required>
                                                                        ...
                                                                        <?php 
                                                                        $pro= $con->query("SELECT * FROM product_setup, subscription WHERE  WHERE product_setup.product_id=subscription.product_id AND subscription.partner_id='$uid'");
