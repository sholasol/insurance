...
<html>
   ...
   include 'nav.php'; 
   $id=$_GET['id'];
   $cus=$con->query("SELECT * FROM users WHERE user_id='$id' ");
   $ro=$cus->fetch_array();
       
   if(isset($_POST['submit'])){
        if(empty($_POST['fname'])){
        $e="Please fill in partner's name!"; 
        echo  " <script>alert('$e'); window.location='edit_marketer.php?id=$id'</script>";
	}
        ...
        $dobb=  $newdob;
            ...
            $reg = $con->query("UPDATE users SET telephone='$phone', email='$email', address='$address', dob='$dobb',lastname='$lname',  firstname='$fname' WHERE user_id='$id' ");
            if($reg){
                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="#">Edit Marketer's Detail</a></li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="fname" id="exampleInputName" value="<?php echo $ro['firstname']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputName">Last Name</label>
                                                                    <input type="text" class="form-control" name="lname" id="exampleInputLName" value="<?php echo $ro['lastname']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputName">Phone</label>
                                                                    <input type="text" class="form-control" name="phone" id="exampleInputPhone" value="<?php echo $ro['telephone']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputEmail">DoB</label>
                                                                    <input type="text" class="form-control date-picker" name="dob" id="exampleInputDoB" value="<?php echo $ro['dob']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputEmail">Email address</label>
                                                                    <input type="email" class="form-control" name="email" id="exampleInputEmail" value="<?php echo $ro['email']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputEmail">Address</label>
                                                                    <input type="text" class="form-control" name="address" id="exampleInputAddress" value="<?php echo $ro['address']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-12">
