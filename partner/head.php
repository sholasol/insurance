                            ...
                            <ul class="nav navbar-nav navbar-left">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        <span class="user-name"><i class="fa fa-home"></i> Insurance<i class="fa fa-angle-down"></i></span>
                                    </a>
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        <li role="presentation"><a href="subscribe.php"><i class="fa fa-newspaper-o"></i>Subscribe</a></li>
                                        <li role="presentation"><a href="subscription.php"><i class="fa fa-list-alt"></i>Manage Subscription</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        <li role="presentation"><a href="product.php"><i class="fa fa-newspaper-o "></i> Product</a></li>
