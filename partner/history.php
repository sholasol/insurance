    ...
    <div class="page-title">
        ...
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li><a href="#">Commission History</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    ...
                                    <h4 class="panel-title pull-right"><a></a></h4>
                                </div>
                                   ...
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <?php 
                                            $p=0;
                                            $cus=$con->query("SELECT * FROM users, transaction WHERE users.user_id = transaction.user_id AND transaction.insurance_id ='$i_id' AND transaction.status !='Terminated' AND transaction.marketer_id > 0");
                                            $counter =0;
                                            while($row=$cus->fetch_array()){
                                                ...
                                                $cnt2=$con->query("SELECT marketer_com, status, created FROM commission WHERE partner_id='$uid' AND marketer_id ='$pat'");
                                                $rw=$cnt2->fetch_array();
                                                $num=$rw['marketer_com'];
                                                $p +=$num;
                                            ?>
