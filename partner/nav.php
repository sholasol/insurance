            ...
            <div class="horizontal-bar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon fa fa-bank"></span><p>Insurance</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li role="presentation"><a href="subscribe.php">Subscribe</a></li>
                                <li role="presentation"><a href="subscription.php">Manage Subscription</a></li>
                                <li role="presentation"><a href="commission.php">Commission</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-user"></span><p>Marketers</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li role="presentation"><a href="mCommission.php">Commission</a></li>
                            </ul>
                        </li>
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-briefcase"></span><p>Claims</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li role="presentation"><a href="sclaim.php">Settled Claim</a></li>
                            </ul>
                        </li>
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon fa fa-newspaper-o"></span><p>Products</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li role="presentation"><a href="product.php">Subscribe to Product</a></li>
