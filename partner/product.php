                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Products( <small>Select Products you would like to subscribe for</small>)</h4>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                       <form name="bulk_action_form" action="product_sub.php" method="post" onsubmit="return subscribeConfirm();"/>   
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Product Name</th>
                                                <th width="5%"><button type="submit"  class="btn btn-info"><span class="fa fa-check-circle"></span> Subscribe</button></th>
                                            </tr>
                                        </thead>
                                        <tfoot>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php
                                            $ins=$con->query("SELECT * FROM product_setup, ipartner WHERE product_setup.insurance_id=ipartner.insurance_id AND ipartner.partner_id ='$uid'   ");
                                            while($row=$ins->fetch_array()){
                                                ...
                                                $ch=$con->query("SELECT count(id) AS id FROM subscription WHERE product_id='$prid' AND insurance_id='$iid' AND partner_id='$uid' ");
                                                $r=$ch->fetch_array();
                                                $sub=$r['id'];
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" value="<?php echo $prid; ?>" name="rid[]">
                                                    <input type="hidden" value="<?php echo $iid; ?>" name="ins[]">
                                                </td>
                                                ...
                                                <td>
                                                    <?php 
                                                    if($sub > 0){echo"<span class='label label-primary'>Subscribed</span> ";}else{echo"<span class='label label-danger'>Not Subscribe</span> ";}
                                                    ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
