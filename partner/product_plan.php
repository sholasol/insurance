                                ...
                                <div class="panel-body">
                                    <div id="rootwizard">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab1" data-toggle="tab"><i class="fa fa-bars m-r-xs"></i>Product Plan</a></li>
                                        </ul>
                                                    ...
                                                    <div class="row m-b-lg">
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputName">Sum Assured</label>
                                                                    <input type="number" class="form-control" name="exampleInputName" id="exampleInputName" placeholder="Sum Assured">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputName">Benefit</label>
                                                                    <input type="number" class="form-control" name="exampleInputName" id="exampleInputName" placeholder="Benefit">
                                                                </div>
