                ...
                <div class="col-md-6">
                    <div class="panel panel-white">
                        <div class="panel-heading clearfix">
                            <h4 class="panel-title">Coverage Area</h4>
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Lagos</td>
                                            <td>ABC MFB</td>
                                            <td>08123452609, 09087634520 </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">2</th>
                                            <td>Abuja</td>
                                            <td>Bespoke Thrift</td>
                                            <td>08076452609, 07087632120 </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">3</th>
                                            <td>Port Harcourt</td>
                                            <td>InsAgency</td>
                                            <td>090923452609, 07044634520 </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
