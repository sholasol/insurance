...
if(isset($_POST['submit'])){
        ...
        echo  " <script>alert('$e'); window.location='index.php?custApi'</script>";
	}
        ...
        if($rr < 1){
            ...
            $reg = $con->query("INSERT INTO users SET telephone='$phone', email='$email', address='$address', lastname='$lname', firstname='$fname', password='$hash',role_id =2, created=now(), createdby='$userid'");
            if($reg){
                ...
                $inn=$con->query("INSERT INTO iuser SET insurance_id ='$company', user_id= '$idd'");
                if($inn){
                    $e="User registration is successful"; 
                    echo  " <script>alert('$e'); window.location='index.php?manageC'</script>"; 
                                ...
                                <div class="panel-body">
                                    <div id="rootwizard">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab1" data-toggle="tab"><i class="fa fa-bars m-r-xs"></i>User Details</a></li>
                                        </ul>
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="phone" id="exampleInputName" placeholder="Telephone Number">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <select class="form-control" name="company">
                                                                        ...
                                                                        <?php 
                                                                        $n=$con->query("SELECT * FROM insurance_company");
                                                                        while($ro=$n->fetch_array()){
                                                                        ?>
                                                                        <option value="<?php echo $ro['company_id']; ?>"><?php echo $ro['company_name']; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="password" class="form-control" name="password" id="exampleInputEmail" placeholder="Password" >
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputEmail">Office address</label>
                                                                    <input type="text" class="form-control" name="address" id="exampleInputEmail" placeholder="Enter email" >
                                                                </div>
                                                                <div class="form-group col-md-12">
