<?php 
$id = $_GET['id'];
$us=$con->query("SELECT * FROM users WHERE user_id='$id'");
$r=$us->fetch_array();

if(isset($_POST['submit'])){
        if(empty($_POST['fname'])){
        $e="Please fill in first name!"; 
        echo  " <script>alert('$e'); window.location='index.php?e_user&id=$id'</script>";
	}
        ...
        $reg = $con->query("UPDATE users SET telephone='$phone', email='$email', address='$address', lastname='$lname', firstname='$fname' WHERE user_id='$userid'");
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="fname" id="exampleInputName" value="<?php echo $r['firstname'];?>" required/>
                                                                </div>
                                                                <div class="form-group  col-md-6">
                                                                    <label for="exampleInputName2">Last Name</label>
                                                                    <input type="text" class="form-control col-md-6" name="lname" id="exampleInputName2" value="<?php echo $r['lastname'];?>" required >
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputName">Phone</label>
                                                                    <input type="text" class="form-control" name="phone" id="exampleInputName" value="<?php echo $r['telephone'];?>" >
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputEmail">Email address</label>
                                                                    <input type="email" class="form-control" name="email" id="exampleInputEmail" value="<?php echo $r['email'];?>" required>
                                                                </div>
