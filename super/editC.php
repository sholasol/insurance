...
<html>
   ...
   $q=$con->query("SELECT * FROM insurance_company WHERE company_id='$id'");
   $r=$q->fetch_array();
...
if(isset($_POST['submit'])){
    if(empty($_POST['name'])){
        ...
        echo  " <script>alert('$e'); window.location='index.php?e_company'</script>";
	}
        ...
        $userid= check_input($_POST["user"]);
            ...
            $reg = $con->query("UPDATE insurance_company SET company_name='$name', prefix='$prefix', rc_no='$rc', phone_no='$phone', address='$address', acct_no='$bank', email='$email' WHERE company_id='$id'");
            if($reg){
                $e="Company information has been successfully updated"; 
                echo  " <script>alert('$e'); window.location='index.php?e_company&id=$id'</script>";
            }else{
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                <div class="form-group col-md-10">
                                                                    ...
                                                                    <input type="text" class="form-control" name="name" id="exampleInputName" value="<?php echo $r['company_name']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-2">
                                                                    <label for="exampleInputName">Company Prefix</label>
                                                                    <input type="text" class="form-control" name="prefix" id="prefix" value="<?php echo $r['prefix']; ?>" required>
                                                                </div>
                                                                <div class="form-group  col-md-6">
                                                                    <label for="exampleInputName2">RC Number</label>
                                                                    <input type="text" class="form-control col-md-6" name="rc" id="exampleInputName2" value="<?php echo $r['rc_no']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputName">Bank Account</label>
                                                                    <input type="text" class="form-control" name="bank" id="exampleInputName" value="<?php echo $r['acct_no']; ?>" />
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputName">Phone</label>
                                                                    <input type="text" class="form-control" name="phone" id="exampleInputName" value="<?php echo $r['phone_no']; ?>" required />
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label for="exampleInputEmail">Email address</label>
                                                                    <input type="email" class="form-control" name="email" id="exampleInputEmail" value="<?php echo $r['email']; ?>" />
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputEmail">Office address</label>
                                                                    <input type="text" class="form-control" name="address" id="exampleInputEmail" value="<?php echo $r['address']; ?>" />
                                                                </div>
                                                                <div class="form-group col-md-12">
