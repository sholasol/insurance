            ...
            <div class="panel-body">
               <div class="table-responsive">
                <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                    ...
                    <tbody>
                        <?php
                        $qq=$con->query("SELECT users.user_id, users.firstname, users.lastname, users.telephone, users.email, users.address, users.role_id, users.created, iuser.insurance_id FROM users, iuser WHERE users.user_id=iuser.user_id");
                        $counter=0;
